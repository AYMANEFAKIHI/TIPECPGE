  ...
  <section className="py-24 bg-muted/20 relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 md:px-6 max-w-4xl relative z-10">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <motion.a href="https://www.instagram.com/tipe_cpge/" target="_blank" rel="noopener noreferrer"
          initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          whileHover={{ y: -4 }} className="group block">
        ...
        <motion.a href="https://www.tiktok.com/@tipe.cpge" target="_blank" rel="noopener noreferrer"
          initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          transition={{ delay: 0.1 }} whileHover={{ y: -4 }} className="group block">
