...
const faqCategories = [
  {
    ...
    faqs: [
      ...
      { q: "Quel sujet TIPE choisir pour le thème 'Cycles, Boucles' 2026 ?", a: "Le thème est volontairement large pour couvrir toutes les filières. En MP : systèmes asservis, oscillateurs, réseaux de Petri. En PSI : moteurs à cycle, systèmes mécaniques périodiques, automates. En TSI : boucles de régulation, cycles thermodynamiques, systèmes à retour. Nous vous aidons à trouver un sujet original et faisable selon votre profil." },
